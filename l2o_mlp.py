...
from config import (
    ...
    L2O_STATE_DIM, NO_AGC_STATE_DIM, L2O_MLP_HISTORY_LEN, L2O_MLP_HIDDEN_DIM, L2O_DFE_HEAD_SCALE,
    L2O_CTLE_HEAD_SCALE, L2O_OVERDRIVE_MAX, L2O_MU_PENALTY, L2O_OVERDRIVE_PENALTY,
    EMA_BETA,
